...
- PRs: #1, #2, #3, #4
- Scope: tooling; artifact-optimization; README, docsync and formatting; doc sync tooling; comprehensive unit tests for core logic; feat unit tests v1 3258527929282857917
